...
# ╔═╡ 61706ae8-a2f1-11ef-0fb5-2126d8c01c3c
using Plots, DifferentialEquations

# ╔═╡ aa077d64-f07e-4d8a-84f3-966c32928739
global vpeak = 35

# ╔═╡ 0adf826e-1275-4648-bbca-12f5ea901150
global vr = -60

# ╔═╡ 7686dcea-94ae-4dc7-98da-9a0b2f58791d
global u0=[vr,0]

# ╔═╡ 83ee5340-bdc7-4898-b205-96c1a070a394
function model!(du, u, p, t)
	C,vt,k=[100,-40,0.7] # parameters used for RS
...
# ╔═╡ ff9adbb7-bde7-4ea6-a5e9-6a26e2abde48
function vpeak_check(u, t, integrator)
	u[1] ≥ vpeak 
end

# ╔═╡ f44b8869-e177-45e7-87af-edd5f74a5e53
...
# ╔═╡ cd896494-4159-4031-86bb-690590ae1b67
cb = DiscreteCallback(vpeak_check, affect!)

# ╔═╡ 1836d664-9c48-4373-a829-f0d93b736920
cbs = CallbackSet(cb)

# ╔═╡ 4e27e165-abc4-4dc1-9287-f70465112382
solutions = []

# ╔═╡ 9548f5fb-e7be-4ab8-a473-4ad47664ff7d
global currents = [60, 70, 85, 100]

# ╔═╡ 41df7c4c-bf68-4090-9f6f-a78dd52049cc
for I=currents
	p(t)=100<t<900 ? I : 0 
	prob = ODEProblem(model!, u0, (0.0, 1000.0), p)
	sol = solve(prob, Tsit5(), callback = cbs)
	push!(solutions, sol)
end

# ╔═╡ 84785c2f-11db-489f-8d86-0942f4b87a3f
begin
	plots = []
	...
	push!(plots, plot(
		1:1000,
		[[100<t<900 ? I : 0 for t=1:1000] for I=currents],
		linewidth=1.2,
		label=reshape(["" for I=currents], 1, :),
		color=reshape([:mediumpurple for I=currents], 1, :),
		xtick=0:200:1000,
		xlabel="time (ms)",
		xguidefontsize=8,
		title="Input current",
...
# ╔═╡ 93939e37-3d1b-4fa5-9a53-ee91baee0461
begin
	layout = @layout [
	    grid(2,2)
	    a{0.15h}
	...
	plot(
		plots..., 
		#layout=(length(currents) + 1,1), 
		layout=layout,
		#size=(300,900),
		plot_title="Figure 8.12: Simple model of Regular Spiking Neuron",
		plot_titlefontsize=12
	)
end

# ╔═╡ 619d222c-c379-4824-96b1-f827e747a28e
savefig("../plots/fig8_12")

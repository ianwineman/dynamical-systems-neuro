...
# ╔═╡ da669e6a-7df1-11ef-3cf8-19736e08ac48
using Plots, DifferentialEquations

# ╔═╡ 46813168-b529-4ce7-b167-9f24cd806979
# Quadratic Integrate and Fire
function qif(t_range, I)
	I = abs(I)
	Vpeak = 30.0
	Vreset = -2
	Vs = []
...
# ╔═╡ 5f1cc83e-b069-469a-a500-94f1e661f657
begin
	# middle row
	I_m = -2.0
	F_m(V) = I_m + V^2
	...
	hline!([-2], linestyle=:dash, color=:red, label="Vreset")
...
# ╔═╡ 3e1afb1c-3006-408f-a131-a837438e6546
savefig("fig3_35.png")

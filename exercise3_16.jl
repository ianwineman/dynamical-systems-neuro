...
# ╔═╡ 9ced82a6-83e3-11ef-057d-2f200d90397d
using Plots, Roots, ForwardDiff, PlotlyJS

# ╔═╡ 926d3aa3-ba65-477f-8dd6-9a3bde74bb03
md"""
``\dot x = a+bx-x^3``
"""

# ╔═╡ cdc1dd42-d438-422d-accc-212221c091bd
zeros = []

# ╔═╡ 37e33144-e97c-41c7-9ce0-8a1adfc8618a
for a=-10:0.1:10
	for b=-10:0.1:10
		F(x) = a + b*x - x^3
		...
		push!(zeros, (a, b, F_zeros, eigenvalues))
	end
end

# ╔═╡ 66e709db-1ddc-4e36-bb0f-ddc9601bdc62
zeros

# ╔═╡ f4f0e36a-16ff-4cd8-ac21-abba2b726437
stable_points = []

# ╔═╡ 8833e1a9-b3af-4cf0-bd62-771c221435c6
unstable_points = []

# ╔═╡ c4522972-d1b3-4157-b755-b36b112ba3dd
for i=zeros
	for (j, val) in enumerate(i[3])
		if i[4][j] ≥ 0
			push!(stable_points, (i[1], i[2], val))
		else
			push!(unstable_points, (i[1], i[2], val))
		end
	end
end
...
Plots.plot(
	[[i[1] for i=stable_points], [i[1] for i=unstable_points]],
	[[i[2] for i=stable_points], [i[2] for i=unstable_points]],
	[[i[3] for i=stable_points], [i[3] for i=unstable_points]],
	seriestype=:scatter,
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "9ac0504b02916006f008bd1b944dc771ef3654c0"

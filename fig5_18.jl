...
# ╔═╡ c3292bcb-6f9f-4074-bd3c-17eca292ca1f
using Plots, DifferentialEquations

# ╔═╡ 77787861-7e3d-490f-aa2c-c327a7b60abe
...
# ╔═╡ b6f8c728-2180-4b03-966b-4d60b3b2ce1f
begin
	# Initial values:
...
# ╔═╡ 23e9ff18-016d-40ca-a842-b007b05fdd40
solution = solve(model)

# ╔═╡ 8c8938c8-4d7f-40a6-8b5e-b56dc543a933
begin
	p1 = plot(
		solution, 
		idxs = (0,1), 
	...
	plot(
		p1, p2, p3, 
		layout=grid(3, 1), 
		plot_title="Figure 5.18: The sum of n(t) + h(t) ≈ 0.84 in the Hodgkin-Huxley model",
		plot_titlefontsize=12,
		size=(900,600)
	)
end

# ╔═╡ 461969ce-bc1d-445a-a22c-2e83de1502ae
savefig("fig5_18")

...
# ╔═╡ 034423aa-a430-11ef-0975-51bd81b62737
using Plots, DifferentialEquations

# ╔═╡ 42eed5bd-5ec0-4bff-a601-b69e5bdd35db
...
# ╔═╡ 72068bcc-5d8a-40f8-ad91-783e9aee2e9d
function condition(u, t, integrator)
	u[1] ≥ 10
end

# ╔═╡ e884bfa1-7558-4b05-a0e5-233e59f17908
function affect!(integrator)
    integrator.u[1] = 1
	integrator.u[2] += 0.2
end

# ╔═╡ 7ad49001-d215-4b8e-996a-0a2a6f281e23
cb = DiscreteCallback(condition, affect!)

# ╔═╡ d305c8f5-6172-441a-80df-3e97cb26d806
cbs = CallbackSet(cb)

# ╔═╡ c04d083d-2e73-494b-ae4c-0184012e06d8
begin
	u0=[-1,2]
	p(t)=1
	prob = ODEProblem(model!, u0, (0.0, 150.0), p)
end

# ╔═╡ 7e931088-7bab-45de-ae5d-217544996550
sol = solve(prob, Rodas5(), callback = cbs)

# ╔═╡ 797f343b-b853-4c65-bb00-1c07ed7522b6
begin
	p1 = plot(
		sol, idxs=(0,1),
		label="",
		...
		xlabel="",
		yticks=0:2:10,
		ylabel="fast variable, v",
		yguidefontsize=10
	)
	annotate!(28, 1, ("reset →", :left, 8))
	...
	p2 = plot(
		...
		ylim=[0,3],
		yticks=0:1:3,
		ylabel="slow variable, u",
		yguidefontsize=10
	)
	hline!([1,2], linestyle=:dash, label="", color=:silver)
	annotate!(2.5, 2.25, ("homoclinic", :left, 8))
	annotate!(2.5, 0.75, ("fold", :left, 8))
	...
	plot(p1, p2, layout=layout, plot_title="Figure 9.29: Fold/homoclinic bursting", plot_titlefontsize=12)
end

# ╔═╡ 42961fef-2d8d-4fb0-8a55-f733895247d4
savefig("../plots/fig9_29")
